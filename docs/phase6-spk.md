...
- `version` uses numeric parts only, for example `0.1.0-0005`
...
```sh
sh scripts/check-spk-archive.sh --spk build/spk/lxc-on-dsm-0.1.0-0005.spk
```
...
```text
build/spk/lxc-on-dsm-0.1.0-0005.spk
```
