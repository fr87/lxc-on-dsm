...
- `version` uses numeric parts only, for example `0.1.0-0006`
...
```sh
sh scripts/check-spk-archive.sh --spk build/spk/lxc-on-dsm-0.1.0-0006.spk
```
...
```text
build/spk/lxc-on-dsm-0.1.0-0006.spk
```
