...
for script in scripts/analyze-dsm.sh scripts/compare-reports.sh scripts/evaluate-report.sh scripts/check-phase2-prereqs.sh scripts/fetch-sources.sh scripts/build-lxc.sh scripts/plan-entware-bootstrap.sh; do
    sh -n "$script"
done
...
if grep -En "$forbidden" scripts/analyze-dsm.sh scripts/compare-reports.sh scripts/evaluate-report.sh scripts/check-phase2-prereqs.sh scripts/fetch-sources.sh scripts/build-lxc.sh; then
